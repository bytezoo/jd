...
function taskUrl(function_path, body = {}) {
  return {
    ...
    headers: {
      ...
      Host: `api.m.jd.com`,
      "User-Agent": `Mozilla/5.0 (Linux; Android 10; MI 8 Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.62 XWEB/2853 MMWEBSDK/201201 Mobile Safari/537.36 MMWEBID/6734 MicroMessenger/8.0.1.1841(0x28000151) Process/appbrand0 WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64 MiniProgramEnv/android`,
      Referer: `https://servicewechat.com/wxa5bf5ee667d91626/151/page-frame.html`,
      "Accept-Encoding": `gzip,compress,br,deflate`,
    },
    body: `body=${JSON.stringify(body)}&appid=swat_miniprogram&client=tjj_m&screen=1920*1080&osVersion=5.0.0&networkType=wifi&sdkName=orderDetail&sdkVersion=1.0.0&clientVersion=3.1.3&area=1_72_4137_0`
  };
}
