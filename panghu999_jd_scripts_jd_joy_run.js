...
//此处填入你需要助力好友的京东用户名
//下面给出好友邀请助力的示例填写规则
let invite_pins =["jd_6d6379d947021","%E8%AF%AD%E9%99%8C868","jd_RxfvxZyLXDzj"];
//下面给出好友赛跑助力的示例填写规则
let run_pins = [""];
...
//temp = ["jd_6d6379d947021"];
//run_pins = [temp.join(',')];
run_pins = ["jd_6d6379d947021","%E8%AF%AD%E9%99%8C868","jd_RxfvxZyLXDzj"];
$.LKYLToken = 'a08a69dfbb4c2a7e42f967fa5b3a2a9f' || $.getdata('jdJoyRunToken');
...
async function main() {
  ...
  $.LKYLToken = 'a08a69dfbb4c2a7e42f967fa5b3a2a9f';
  console.log(`打印token \n${$.LKYLToken}\n`)
  if (!$.LKYLToken) {
